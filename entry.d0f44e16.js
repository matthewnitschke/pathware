...
var PathViewer = function (_Component) {
    ...
    function PathViewer(props) {
        _classCallCheck(this, PathViewer);

        var _this = _possibleConstructorReturn(this, (PathViewer.__proto__ || Object.getPrototypeOf(PathViewer)).call(this, props));
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.selectedTab == 'Acronym' && _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement('textarea', { value: this.getLetters(this.state.pathText), disabled: true })
                        ),
                        this.state.selectedTab == 'Text' && _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement('textarea', { name: 'pathText', value: this.state.pathText, onChange: this.handleChange })
                        )
                    )
                )
            );
